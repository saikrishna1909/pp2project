...
public class TeacherPerSubjectDaoImpl implements TeacherPerSubjectDao {
    ...
    public SQLState updateOneSubject(JSONObject jsonObject) {
        ...
        try {
            ...
            System.out.println("----> jsonObject.getInt(\"teacherId\"): " + ((ResultSet) jsonObject).getInt("teacherId"));
            System.out.println("----> jsonObject.getString(\"subjectName\"): " + ((ResultSet) jsonObject).getString("subjectName"));
            System.out.println("----> jsonObject.getString(\"subjectId\"): " + ((ResultSet) jsonObject).getString("subjectId"));
