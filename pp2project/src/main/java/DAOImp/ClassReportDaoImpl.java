...
public class ClassReportDaoImpl implements ClassReportDao {
	...
	public List<ClassFull> getAllStudents() throws SQLException {
		...
		while (rs.next()) {
			...
			ClassFull student = new ClassFull(classId, className, studentId, studentName, teacherId, teacherName,
	...
	public List<Class> getAllClasses() throws SQLException {
		...
		while (rs.next()) {
			String classId = rs.getString("class_id");
			String className = rs.getString("class_name");
			Class clase = new Class(classId, className);
	...
	@Override
	public SQLState deleteOneStudent(JSONObject jsonObject) throws JSONException {
	...
	@Override
	public SQLState updateOneStudent(JSONObject jsonObject) throws JSONException {
